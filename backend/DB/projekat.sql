...
--
ALTER TABLE `team`
  MODIFY `idTima` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `klijent`
  ADD CONSTRAINT `klijent_ibfk_1` FOREIGN KEY (`idProjekat`) REFERENCES `projekat` (`idProjekat`) on delete CASCADE;

--
-- Constraints for table `partner_projekta`
--
ALTER TABLE `partner_projekta`
  ADD CONSTRAINT `partner_projekta_ibfk_1` FOREIGN KEY (`idProjekat`) REFERENCES `projekat` (`idProjekat`) on delete CASCADE,
  ADD CONSTRAINT `partner_projekta_ibfk_2` FOREIGN KEY (`idPartner`) REFERENCES `partner` (`idPartner`) on delete CASCADE;
--
-- Constraints for table `team`
--  
ALTER TABLE `team`
  ADD CONSTRAINT `team_ibfk_1` FOREIGN KEY (`idProjekat`) REFERENCES `projekat` (`idProjekat`) on delete CASCADE;

--
-- Constraints for table `zaposleni`
--
ALTER TABLE `zaposleni`
  ADD CONSTRAINT `zaposleni_ibfk_1` FOREIGN KEY (`idTima`) REFERENCES `team` (`idTima`) on delete CASCADE;
